 ...
 */
const mergeWithDefaultOptions = (opts = {}) =>
...
const BASIC_KUNREI = {
  a: "あ",
  b: { a: "ば", e: "べ", i: "び", o: "ぼ", u: "ぶ" },
  d: { a: "だ", e: "で", i: "ぢ", o: "ど", u: "づ" },
  e: "え",
  g: { a: "が", e: "げ", i: "ぎ", o: "ご", u: "ぐ" },
  h: { a: "は", e: "へ", i: "ひ", o: "ほ", u: "ふ" },
  i: "い",
  k: { a: "か", e: "け", i: "き", o: "こ", u: "く" },
  m: { a: "ま", e: "め", i: "み", o: "も", u: "む" },
  n: { a: "な", e: "ね", i: "に", o: "の", u: "ぬ" },
  o: "お",
  p: { a: "ぱ", e: "ぺ", i: "ぴ", o: "ぽ", u: "ぷ" },
  r: { a: "ら", e: "れ", i: "り", o: "ろ", u: "る" },
  s: { a: "さ", e: "せ", i: "し", o: "そ", u: "す" },
  t: { a: "た", e: "て", i: "ち", o: "と", u: "つ" },
  u: "う",
  v: { a: "ゔぁ", e: "ゔぇ", i: "ゔぃ", o: "ゔぉ", u: "ゔ" },
  w: { a: "わ", e: "ゑ", i: "ゐ", o: "を" },
  y: { a: "や", o: "よ", u: "ゆ" },
  z: { a: "ざ", e: "ぜ", i: "じ", o: "ぞ", u: "ず" },
};
...
const SMALL_Y$1 = { ya: "ゃ", ye: "ぇ", yi: "ぃ", yo: "ょ", yu: "ゅ" };
const SMALL_VOWELS = { a: "ぁ", e: "ぇ", i: "ぃ", o: "ぉ", u: "ぅ" };
...
const onInput = ({ target: { value, selectionStart, selectionEnd } }) =>
  console.log("input:", { selectionEnd, selectionStart, value });
...
function isCharKanji(char = "") {
  return (
    isCharInRange(char, KANJI_START, KANJI_END) || isCharIterationMark(char)
  );
}
...
const isCharInitialLongDash = (char, index) =>
...
const isLeadingWithoutInitialKana = (input, leading) =>
  leading && !isKana(input[0]);
const isTrailingWithoutFinalKana = (input, leading) =>
  !leading && !isKana(input[input.length - 1]);
const isInvalidMatcher = (input, matchKanji) =>
  (matchKanji && ![...matchKanji].some(isKanji)) ||
  (!matchKanji && isKana(input));
/**
